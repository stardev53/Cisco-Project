...
```
dhcpd dns 8.8.8.8
dhcpd address 172.18.15.2-172.18.15.10 inside
dhcpd option 150 ip 172.18.15.1 interface inside
dhcpd enable inside
...
access-list DMZ extended permit ip any 172.17.15.0 255.255.255.0 
...
object network HTTP
 nat (dmz,outside1) static 1.15.0.2
object network dmz
 nat (dmz,outside1) dynamic interface
object network HTTPS
 nat (dmz,outside2) static 1.15.0.2
object network dmz1
